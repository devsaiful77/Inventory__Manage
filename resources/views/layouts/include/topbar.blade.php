<header id="page-topbar">
    <div class="navbar-header">
        <div class="d-flex">
            ...
            <form class="app-search d-none d-lg-block" style="margin-right:30px" action="#" method="post">
              @csrf
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item" href=""><i class="bx bx-user font-size-16 align-middle mr-1"></i> <span>Profile</span></a>
